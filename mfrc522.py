...
class MFRC522:
    ...
    def __init__(self, spi=None, gpioRst=None, gpioCs=None):
        ...
        if spi is not None:
            ...
            elif uname()[0] == 'esp32': # TODO update to match https://github.com/cefn/avatap/blob/master/python/host/cockle.py #prepareHost()
                self.spi = SoftSPI(baudrate=100000, polarity=0, phase=0, sck=sck, mosi=mosi, miso=miso)
                self.spi.init()
            else:
